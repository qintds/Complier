...
public class Fac {
    public static void main (String[] args) {
        ...
        LLVMSetDataLayout(mod, "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128");
//        LLVMSetTarget(mod, "");
...
//        LLVMBuildMul(builder, n, call_fac, "n * fac(n - 1)");
        LLVMBuildBr(builder, end);
...
//        LLVMAddCFGSimplificationPass(pass);
        ...
        LLVMGenericValueRef exec_args1 = LLVMCreateGenericValueOfInt(LLVMInt32Type(), 5, 0);
        LLVMGenericValueRef exec_res1 = LLVMRunFunction(engine, fac, 1, exec_args1);
        System.err.println("; Result: " + LLVMGenericValueToInt(exec_res1, 0));
